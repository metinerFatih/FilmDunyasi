...
namespace FilmDunyasi.Migrations
{
    ...
    [Migration("20230206092253_migo_3_Added_Tur")]
    partial class migo_3_Added_Tur
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FilmDunyasi.Data.Film", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilmDunyasi.Data.Tur", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilmTur", b =>
                {
                    b.HasOne("FilmDunyasi.Data.Film", null)
                        .WithMany()
                        .HasForeignKey("FilmlerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FilmDunyasi.Data.Tur", null)
                        .WithMany()
